...
</code></pre><p>3、最终结束的时候，如果b&gt;T,说明还有剩余c=b-T</p><p>4、送了多少草a，剩下多少草c，a-c就是吃的草数量</p><p>03【难度】</p><p>非常友好，略低于青铜级别平均</p><h2 id="_04【原题链接】" tabindex="-1">04【原题链接】 <a class="header-anchor" href="#_04【原题链接】" aria-label="Permalink to &quot;04【原题链接】&quot;">​</a></h2><p><a href="https://usaco.org/index.php?page=viewproblem2&amp;cpid=1299" target="_blank" rel="noreferrer">https://usaco.org/index.php?page=viewproblem2&amp;cpid=1299</a></p><h2 id="【赛事介绍】" tabindex="-1">【赛事介绍】 <a class="header-anchor" href="#【赛事介绍】" aria-label="Permalink to &quot;【赛事介绍】&quot;">​</a></h2><p>Bessie is a hungry cow. Each day, for dinner, if there is a haybale in the barn, she will eat one haybale. Farmer John does not want Bessie to starve, so some days he sends a delivery of haybales, which arrive in the morning (before dinner). In particular, on day di, Farmer John sends a delivery of bi haybales (1≤di≤10<strong>14, 1≤bi≤10</strong>9).</p><pre><code>USACO，美国计算机奥林匹克竞赛， 是一项认可度极高的比赛。 有青铜、白银、黄金、铂金四个级别，每年12-3月举办四期比赛，优胜者晋级。

主要算法：双指针、贪婪、洪水填充、TTC、并查集、DP、前缀和、区间和、二分查找、DFS、BFS、MST、分治、 递归、坐标压缩、递增栈、扫描线、线段树、RMQ、LCA等

相关赛事：ACM、NOI 、CCPC、蓝桥杯 
</code></pre><div> USACO，美国计算机奥林匹克竞赛，是一项认可度极高的比赛。 有青铜、白银、黄金、铂金四个级别，每年12-3月举办四期比赛，优胜者晋级。 <pre><code>主要算法：双指针、贪婪、洪水填充、TTC、并查集、DP、前缀和、区间和、二分查找、DFS、BFS、MST、分治、 递归、坐标压缩、递增栈、扫描线、线段树、RMQ、LCA等

相关赛事：ACM、NOI 、CCPC、蓝桥杯 
</code></pre></div><p>word-wrap: break-word; /* 当单词太长无法在一行内容纳时，自动将单词拆分成多行 <em>/ word-break: break-all; /</em> 允许在单词内换行 */</p>`,26),i=[t];function d(s,h,l,p,c,b){return r(),a("div",null,i)}const f=e(o,[["render",d]]);export{_ as __pageData,f as default};
